...
public class GameBoard {
	...
	private Felt[] createLogicFields() {
		...
		logiskeFelter[1] = new Territory(1200, 300, "Rødovrevej", this, rb);
		logiskeFelter[2] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[3] = new Territory(1200, 300, "Hvidovrevej", this, rb);
		logiskeFelter[4] = new Tax(4000, "Betal indkomstskat", this, rb);
		logiskeFelter[5] = new ShippingCompany(4000, "SFL-Færgerne", this, rb);
		logiskeFelter[6] = new Territory(2000, 400, "Roskildevej", this, rb);
		logiskeFelter[7] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[8] = new Territory(2000, 400, "Valby Langgade", this, rb);
		logiskeFelter[9] = new Territory(2400, 500, "Allégade", this, rb);
		logiskeFelter[10] = new Jail("I Fængsel", this, rb);
		logiskeFelter[11] = new Territory(2800, 700, "Frederiksberg Allé", this, rb);
		logiskeFelter[12] = new Brewery(3000, "Tuborg",diceCup, this, rb);
		logiskeFelter[13] = new Territory(2800, 700, "Bülowsvej", this, rb);
		logiskeFelter[14] = new Territory(3200, 800, "Gl. Kongevej", this, rb);
		logiskeFelter[15] = new ShippingCompany(4000, "DSB Kalundborg/Århus", this, rb);
		logiskeFelter[16] = new Territory(3600, 900, "Bernstorffsvej", this, rb);
		logiskeFelter[17] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[18] = new Territory(3600, 900, "Hellerupvej", this, rb);
		logiskeFelter[19] = new Territory(4000, 1000, "Strandvej", this, rb);
		logiskeFelter[20] = new Parking("Parkering", this, rb);
		logiskeFelter[21] = new Territory(4400, 1100, "Trianglen", this, rb);
		logiskeFelter[22] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[23] = new Territory(4400, 1100, "Østerbrogade", this, rb);
		logiskeFelter[24] = new Territory(4800, 1200, "Grønningen", this, rb);
		logiskeFelter[25] = new ShippingCompany(4000, "DFDS Seaways", this, rb);
		logiskeFelter[26] = new Territory(5200, 1300, "Bredgade", this, rb);
		logiskeFelter[27] = new Territory(5200, 1300, "Kgs. Nytorv", this, rb);
		logiskeFelter[28] = new Brewery(3000, "Coca-Cola",diceCup, this, rb);
		logiskeFelter[29] = new Territory(5600, 1400, "Østergade", this, rb);
		logiskeFelter[30] = new GoToJail("De Fængsles", this, rb);
		logiskeFelter[31] = new Territory(6000, 1500, "Amagertorv", this, rb);
		logiskeFelter[32] = new Territory(6000, 1500, "Vimmelskaftet", this, rb);
		logiskeFelter[33] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[34] = new Territory(6400, 1600,  "Nygade", this, rb);
		...
		logiskeFelter[37] = new Territory(7000, 1700, "Frederiksberggade", this, rb);
		logiskeFelter[38] = new Tax(2000, "Ekstraordinær statsskat", this, rb);
		logiskeFelter[39] = new Territory(8000, 2000, "Rådhuspladsen", this, rb);
	...
	private void initFields() {
		...
		guiFields[26].setTitle("Bredgade"); guiFields[26].setDescription("Pris: 520 <BR> Leje: 450 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[26].setSubText("Territory");
