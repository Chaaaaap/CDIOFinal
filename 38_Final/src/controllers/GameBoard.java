...
public class GameBoard {
	...
	private Felt[] createLogicFields() {
		...
		logiskeFelter[1] = new Territory(1200, 100, "Rødovrevej", this, rb, "blue");
		logiskeFelter[2] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[3] = new Territory(1200, 100, "Hvidovrevej", this, rb, "blue");
		logiskeFelter[4] = new Tax(4000, "Betal indkomstskat", this, rb);
		logiskeFelter[5] = new ShippingCompany(4000, "SFL-Færgerne", this, rb);
		logiskeFelter[6] = new Territory(2000, 100, "Roskildevej", this, rb, "pink");
		logiskeFelter[7] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[8] = new Territory(2000, 100, "Valby Langgade", this, rb, "pink");
		logiskeFelter[9] = new Territory(2400, 150, "Allégade", this, rb, "pink");
		logiskeFelter[10] = new Jail("I Fængsel", this, rb);
		logiskeFelter[11] = new Territory(2800, 200, "Frederiksberg Allé", this, rb, "green");
		logiskeFelter[12] = new Brewery(3000, "Tuborg",diceCup, this, rb);
		logiskeFelter[13] = new Territory(2800, 200, "Bülowsvej", this, rb, "green");
		logiskeFelter[14] = new Territory(3200, 250, "Gl. Kongevej", this, rb, "green");
		logiskeFelter[15] = new ShippingCompany(4000, "DSB Kalundborg/Århus", this, rb);
		logiskeFelter[16] = new Territory(3600, 300, "Bernstorffsvej", this, rb, "gray");
		logiskeFelter[17] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[18] = new Territory(3600, 300, "Hellerupvej", this, rb, "gray");
		logiskeFelter[19] = new Territory(4000, 350, "Strandvej", this, rb, "gray");
		logiskeFelter[20] = new Parking("Parkering", this, rb);
		logiskeFelter[21] = new Territory(4400, 350, "Trianglen", this, rb, "red");
		logiskeFelter[22] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[23] = new Territory(4400, 350, "Østerbrogade", this, rb, "red");
		logiskeFelter[24] = new Territory(4800, 400, "Grønningen", this, rb, "red");
		logiskeFelter[25] = new ShippingCompany(4000, "DFDS Seaways", this, rb);
		logiskeFelter[26] = new Territory(5200, 450, "Bredgade", this, rb, "white");
		logiskeFelter[27] = new Territory(5200, 450, "Kgs. Nytorv", this, rb, "white");
		logiskeFelter[28] = new Brewery(3000, "Coca-Cola",diceCup, this, rb);
		logiskeFelter[29] = new Territory(5600, 500, "Østergade", this, rb, "white");
		logiskeFelter[30] = new GoToJail("De Fængsles", this, rb);
		logiskeFelter[31] = new Territory(6000, 550, "Amagertorv", this, rb, "yellow");
		logiskeFelter[32] = new Territory(6000, 550, "Vimmelskaftet", this, rb, "yellow");
		logiskeFelter[33] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[34] = new Territory(6400, 600,  "Nygade", this, rb, "yellow");
		...
		logiskeFelter[37] = new Territory(7000, 700, "Frederiksberggade", this, rb, "magenta");
		logiskeFelter[38] = new Tax(2000, "Ekstraordinær statsskat", this, rb);
		logiskeFelter[39] = new Territory(8000, 1000, "Rådhuspladsen", this, rb, "magenta");
