...
public class GameBoard {
	...
	private void initFields() {
		...
		guiFields[1].setTitle("Rødovrevej"); guiFields[1].setDescription("Pris: 1200 <BR> Leje: 100 <BR> Hus: 1000 <BR> Hotel: 1000"); guiFields[1].setSubText(rb.getString("Grund"));
		guiFields[2].setTitle("Prøv Lykken"); guiFields[2].setDescription("Træk et kort"); guiFields[2].setSubText(" ");
		guiFields[3].setTitle("Hvidovrevej"); guiFields[3].setDescription("Pris: 1200 <BR> Leje: 100 <BR> Hus: 1000 <BR> Hotel: 1000"); guiFields[3].setSubText(rb.getString("Grund"));
		guiFields[4].setTitle("Betal indkomst skat"); guiFields[4].setDescription("Betal indkomstskat 10% eller kr. 4000"); guiFields[4].setSubText(rb.getString("Tax"));
		guiFields[5].setTitle("SFL Færgerne"); guiFields[5].setDescription("Pris: 4000 <BR> Leje: 500"); guiFields[5].setSubText(rb.getString("Rederi"));
		guiFields[6].setTitle("Roskildevej"); guiFields[6].setDescription("Pris: 2000 <BR> Leje: 100 <BR> Hus: 1000 <BR>Hotel: 1000"); guiFields[6].setSubText(rb.getString("Grund"));
		guiFields[7].setTitle("Prøv Lykken"); guiFields[7].setDescription("Træk et kort"); guiFields[7].setSubText(" ");
		guiFields[8].setTitle("Valby Langgade"); guiFields[8].setDescription("Pris: 2000 <BR> Leje: 100 <BR> Hus: 1000 <BR> Hotel: 1000"); guiFields[8].setSubText(rb.getString("Grund"));
		guiFields[9].setTitle("Allégade"); guiFields[9].setDescription("Pris: 2400 <BR> Leje: 150 <BR> Hus: 1000 <BR> Hotel: 1000"); guiFields[9].setSubText(rb.getString("Grund"));
		guiFields[10].setTitle("I Fængsel"); guiFields[10].setDescription("I Fængsel"); guiFields[10].setSubText("I Fængsel");
		guiFields[11].setTitle("Frederiks- berg Allé"); guiFields[11].setDescription("Pris: 2800 <BR> Leje: 200 <BR>Hus: 2000 <BR> Hotel: 2000"); guiFields[11].setSubText(rb.getString("Grund"));
		guiFields[12].setTitle("Tuborg Bryggeri"); guiFields[12].setDescription("Leje: 100 x antal øjne"); guiFields[12].setSubText(rb.getString("Bryggeri"));
		guiFields[13].setTitle("Bülowsvej"); guiFields[13].setDescription("Pris: 2800 <BR> Leje: 200 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[13].setSubText(rb.getString("Grund"));
		guiFields[14].setTitle("Gl. Kongevej"); guiFields[14].setDescription("Pris: 3200 <BR> Leje: 250 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[14].setSubText(rb.getString("Grund"));
		guiFields[15].setTitle("DSB Kalundborg/ Århus"); guiFields[15].setDescription("Pris: 4000 <BR> Leje: 500"); guiFields[15].setSubText(rb.getString("Rederi"));
		guiFields[16].setTitle("Bernstorff- vej"); guiFields[16].setDescription("Pris: 3600 <BR> Leje: 300 <BR> Hus: 2000 <BR>Hotel: 2000"); guiFields[16].setSubText(rb.getString("Grund"));
		guiFields[17].setTitle("Prøv Lykken"); guiFields[17].setDescription("Træk et kort"); guiFields[17].setSubText(" ");
		guiFields[18].setTitle("Hellerupvej"); guiFields[18].setDescription("Pris: 3600 <BR> Leje: 300 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[18].setSubText(rb.getString("Grund"));
		guiFields[19].setTitle("Strandvej"); guiFields[19].setDescription("Pris: 4000 <BR> Leje: 350 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[19].setSubText(rb.getString("Grund"));
		guiFields[20].setTitle("Parkering"); guiFields[20].setDescription("Der sker ingenting her!"); guiFields[20].setSubText("Parking");
		guiFields[21].setTitle("Trianglen"); guiFields[21].setDescription("Pris: 4400 <BR> Leje: 350 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[21].setSubText(rb.getString("Grund"));
		guiFields[22].setTitle("Prøv Lykken"); guiFields[22].setDescription("Træk et kort"); guiFields[22].setSubText(" ");
		guiFields[23].setTitle("Østerbro- gade"); guiFields[23].setDescription("Pris: 4400 <BR> Leje: 350 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[23].setSubText(rb.getString("Grund"));
		guiFields[24].setTitle("Grønningen"); guiFields[24].setDescription("Pris: 4800 <BR> Leje: 400 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[24].setSubText(rb.getString("Grund"));
		guiFields[25].setTitle("DFDS Seaways"); guiFields[25].setDescription("Pris: 4000 <BR> Leje: 500"); guiFields[25].setSubText(rb.getString("Rederi"));
		guiFields[26].setTitle("Bredgade"); guiFields[26].setDescription("Pris: 5200 <BR> Leje: 450 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[26].setSubText(rb.getString("Grund"));
		guiFields[27].setTitle("Kgs. Nytorv"); guiFields[27].setDescription("Pris: 5200 <BR> Leje: 450 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[27].setSubText(rb.getString("Grund"));
		guiFields[28].setTitle("Coca-Cola Tapperi"); guiFields[28].setDescription("Leje: 100 x antal øjne"); guiFields[28].setSubText(rb.getString("Bryggeri"));
		guiFields[29].setTitle("Østergade"); guiFields[29].setDescription("Pris: 5600 <BR> Leje: 500 <BR> Hus: 3000 <BR> Hotel: 3000"); guiFields[29].setSubText(rb.getString("Grund"));
		guiFields[30].setTitle("De Fængsles"); guiFields[30].setDescription("Du bliver overflyttet til fængslet"); guiFields[30].setSubText(" ");
		guiFields[31].setTitle("Amagertorv"); guiFields[31].setDescription("Pris: 6000 <BR> Leje: 550 <BR> Hus: 4000 <BR> Hotel: 4000"); guiFields[31].setSubText(rb.getString("Grund"));
		guiFields[32].setTitle("Vimmel- skaftet"); guiFields[32].setDescription("Pris: 6000 <BR> Leje: 550 <BR> Hus: 4000 <BR> Hotel: 4000"); guiFields[32].setSubText(rb.getString("Grund"));
		guiFields[33].setTitle("Prøv Lykken"); guiFields[33].setDescription("Træk et kort"); guiFields[33].setSubText(" ");
		guiFields[34].setTitle("Nygade"); guiFields[34].setDescription("Pris: 6400 <BR> Leje: 600 <BR> Hus: 4000 <BR> Hotel: 4000"); guiFields[34].setSubText(rb.getString("Grund"));
		guiFields[35].setTitle("DSB Halsskov/ Knudshoved"); guiFields[35].setDescription("Pris: 4000 <BR> Leje: 500"); guiFields[35].setSubText(rb.getString("Rederi"));
		guiFields[36].setTitle("Prøv Lykken"); guiFields[36].setDescription("Træk et kort"); guiFields[36].setSubText(" ");
		guiFields[37].setTitle("Frederiks- berggade"); guiFields[37].setDescription("Pris: 7000 <BR> Leje: 700 <BR> Hus: 4000 <BR> Hotel: 4000"); guiFields[37].setSubText(rb.getString("Grund"));
		guiFields[38].setTitle("Ekstra ordinær statsskat"); guiFields[38].setDescription("Ekstraordinær statsskat <BR> Betal kr. 2000"); guiFields[38].setSubText(rb.getString("Tax"));
		guiFields[39].setTitle("Rådhus- pladsen"); guiFields[39].setDescription("Pris: 8000 <BR> Leje: 1000 <BR> Hus: 4000 <BR> Hotel: 4000"); guiFields[39].setSubText(rb.getString("Grund"));
