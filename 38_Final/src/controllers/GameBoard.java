...
public class GameBoard {
	...
	private void initFields() {
		...
		guiFields[13].setTitle("Bülowsvej"); guiFields[13].setDescription("Pris: 2800\nLeje: 200 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[13].setSubText("Territory");
		...
		guiFields[15].setTitle("DSB Kalundborg/Århus"); guiFields[15].setDescription("Shipping Company <BR> Pris: 4000 <BR> Leje: 500"); guiFields[15].setSubText("Shipping Company");
		guiFields[16].setTitle("Bernstorffvej"); guiFields[16].setDescription("Territory <BR> Pris: 3600 <BR> Leje: 300 <BR> Hus: 2000 <BR>Hotel: 2000"); guiFields[16].setSubText("Territory");
		guiFields[17].setTitle("Prøv Lykken"); guiFields[17].setDescription("Chance <BR> Træk et kort"); guiFields[17].setSubText("Chance");
		guiFields[18].setTitle("Hellerupvej"); guiFields[18].setDescription("Territory <BR> Pris: 3600 <BR> Leje: 300 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[18].setSubText("Territory");
		guiFields[19].setTitle("Strandvej"); guiFields[19].setDescription("Territory <BR> Pris: 4000 <BR> Leje: 350 <BR> Hus: 2000 <BR> Hotel: 2000"); guiFields[19].setSubText("Territory");
		guiFields[20].setTitle("Parkering"); guiFields[20].setDescription("Parking <BR> Der sker ingenting her!"); guiFields[20].setSubText("Parking");
		guiFields[21].setTitle("Trianglen"); guiFields[21].setDescription("Territory <BR>Pris: 4400\nLeje: 350\nHus: 3000\nHotel: 3000"); guiFields[21].setSubText("Territory");
