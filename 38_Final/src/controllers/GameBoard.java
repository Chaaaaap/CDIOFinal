...
public class GameBoard {
	...
	private Felt[] createLogicFields() {
		...
		logiskeFelter[1] = new Territory(1200, 100, "Rødovrevej", this, rb, "blue",2, 1000);
		logiskeFelter[2] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[3] = new Territory(1200, 100, "Hvidovrevej", this, rb, "blue",4, 1000);
		logiskeFelter[4] = new Tax(4000, "Betal indkomstskat", this, rb);
		logiskeFelter[5] = new ShippingCompany(4000, "SFL-Færgerne", this, rb);
		logiskeFelter[6] = new Territory(2000, 100, "Roskildevej", this, rb, "pink",7, 1000);
		logiskeFelter[7] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[8] = new Territory(2000, 100, "Valby Langgade", this, rb, "pink",9, 1000);
		logiskeFelter[9] = new Territory(2400, 150, "Allégade", this, rb, "pink",10, 1000);
		logiskeFelter[10] = new Jail("I Fængsel", this, rb);
		logiskeFelter[11] = new Territory(2800, 200, "Frederiksberg Allé", this, rb, "green",12, 2000);
		logiskeFelter[12] = new Brewery(3000, "Tuborg",diceCup, this, rb);
		logiskeFelter[13] = new Territory(2800, 200, "Bülowsvej", this, rb, "green",14, 2000);
		logiskeFelter[14] = new Territory(3200, 250, "Gl. Kongevej", this, rb, "green",15, 2000);
		logiskeFelter[15] = new ShippingCompany(4000, "DSB Kalundborg/Århus", this, rb);
		logiskeFelter[16] = new Territory(3600, 300, "Bernstorffsvej", this, rb, "gray",17, 2000);
		logiskeFelter[17] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[18] = new Territory(3600, 300, "Hellerupvej", this, rb, "gray",19, 2000);
		logiskeFelter[19] = new Territory(4000, 350, "Strandvej", this, rb, "gray",20, 2000);
		logiskeFelter[20] = new Parking("Parkering", this, rb);
		logiskeFelter[21] = new Territory(4400, 350, "Trianglen", this, rb, "red",22, 3000);
		logiskeFelter[22] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[23] = new Territory(4400, 350, "Østerbrogade", this, rb, "red",24, 3000);
		logiskeFelter[24] = new Territory(4800, 400, "Grønningen", this, rb, "red",25, 3000);
		logiskeFelter[25] = new ShippingCompany(4000, "DFDS Seaways", this, rb);
		logiskeFelter[26] = new Territory(5200, 450, "Bredgade", this, rb, "white",27, 3000);
		logiskeFelter[27] = new Territory(5200, 450, "Kgs. Nytorv", this, rb, "white",28, 3000);
		logiskeFelter[28] = new Brewery(3000, "Coca-Cola",diceCup, this, rb);
		logiskeFelter[29] = new Territory(5600, 500, "Østergade", this, rb, "white",30, 3000);
		logiskeFelter[30] = new GoToJail("De Fængsles", this, rb);
		logiskeFelter[31] = new Territory(6000, 550, "Amagertorv", this, rb, "yellow",32, 4000);
		logiskeFelter[32] = new Territory(6000, 550, "Vimmelskaftet", this, rb, "yellow",33, 4000);
		logiskeFelter[33] = new ChanceField("Prøv Lykken", this, rb);
		logiskeFelter[34] = new Territory(6400, 600,  "Nygade", this, rb, "yellow",35, 4000);
		...
		logiskeFelter[37] = new Territory(7000, 700, "Frederiksberggade", this, rb, "magenta",38, 4000);
		logiskeFelter[38] = new Tax(2000, "Ekstraordinær statsskat", this, rb);
		logiskeFelter[39] = new Territory(8000, 1000, "Rådhuspladsen", this, rb, "magenta",40, 4000);
